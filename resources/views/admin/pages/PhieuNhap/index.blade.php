        ...
        $(document).on('click','.btn-delete',function (){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    let url = '/admin/phieunhap/delete/' + id;
                    console.log(url);
                    $.ajax({
                        url: url,
                        type: 'get',
...
@section('actions_layout')
    <a href="{{route('admin.phieunhap.create')}}" class="btn btn-primary btn-sm mr-2 mb-2 mb-lg-0">
    ...
    <div class="table-responsive">
        <table id="kt_datatable_horizontal_scroll" class="table table-row-dashed gy-5 gs-7">
            ...
            <tr class="fw-semibold fs-6 text-gray-800">
                ...
                <th class="min-w-50">Mã Phiếu Nhập</th>
                <th class="min-w-50">Mã Đầu Sách</th>
                <th class="min-w-200">Tên Sách </th>
                <th class="min-w-150">Tên Nhà Cung Cấp</th>
                <th class="min-w-150">Người Nhập</th>
                <th class="min-w-150">Số Lượng</th>
                        ...
                        <td>
                            <div class="btn-toolbar justify-content-between" role="toolbar" aria-label="Toolbar with button groups">
                                <div class="btn-group" role="group" aria-label="First group">
                                    ...
                                    <button data-action="{{$item->MaPhieuNhap}}"

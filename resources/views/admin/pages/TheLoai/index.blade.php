        ...
        $(document).on('click','.btn-delete',function (){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    let url = '/admin/theloai/delete/' + id;
                    console.log(url);
                    $.ajax({
                        url: url,
                        type: 'get',
...
@section('actions_layout')
    <a href="{{route('admin.theloai.create')}}" class="btn btn-primary btn-sm mr-2 mb-2 mb-lg-0">
            ...
            @foreach($theLoais as $item)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{route('admin.theloai.edit', $item->MaTL)}}"
                           class="btn btn-sm btn-clean btn-icon btn-icon-md btn-primary mr-2"
                           title="Edit">
                            <i class="fa fa-edit"></i>
                        </a>
                        <button data-action="{{$item->MaTL}}"

...
@section('content_card')
    <form action="{{route('admin.sach.store')}}" method="post" class="form-control-sm">
        @csrf
        <div class="mb-10">
            ...
            <select class="form-select form-select-solid" data-control="select2"
                ...
                @foreach($dauSachs as $item)
                    <option value="{{$item->MaDauSach}}">{{$item->TenSach}}</option>
        ...
        <div class="mb-10">
            ...
            <input name="TinhTrang" type="text" class="form-control form-control-solid"
                   placeholder="Nhập Tình Trạng" value="{{old('TinhTrang')}}" autocomplete="off">
        </div>

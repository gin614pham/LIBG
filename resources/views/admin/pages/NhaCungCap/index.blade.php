        ...
        $(document).on('click','.btn-delete',function (){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    let url = '/admin/nhacungcap/delete/' + id;
                    console.log(url);
                    $.ajax({
                        url: url,
                        type: 'get',
...
@section('actions_layout')
    <a href="{{route('admin.nhacungcap.create')}}" class="btn btn-primary btn-sm mr-2 mb-2 mb-lg-0">
    ...
    <div class="table-responsive">
        <table id="kt_datatable_horizontal_scroll" class="table table-row-dashed gy-5 gs-7">
            ...
            <tr class="fw-semibold fs-6 text-gray-800">
                ...
                <th class="min-w-50">Mã Nhà Cung Cấp</th>
                <th class="min-w-200">Tên Nhà Cung Cấp</th>
                <th class="min-w-150">Địa Chỉ</th>
            ...
            @foreach($nhaCungCaps as $item)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{route('admin.nhacungcap.edit', $item->MaNCC)}}"
                           class="btn btn-sm btn-clean btn-icon btn-icon-md btn-primary mr-2"
                           title="Edit">
                            <i class="fa fa-edit"></i>
                        </a>
                        <button data-action="{{$item->MaNCC}}"
